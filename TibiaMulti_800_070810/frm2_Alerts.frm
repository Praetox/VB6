...
'ALERT AT HP/MANA RELATED
    ...
    Sub HP_Timer_Timer()
        If Compiled = True Then On Error Resume Next
        If HP_Less Then If mReadLong(a + CH_HP) < Int(HP_Value) Then enAlert
        If HP_More Then If mReadLong(a + CH_HP) > Int(HP_Value) Then enAlert
    End Sub
    ...
    Sub Mana_Timer_Timer()
        If Compiled = True Then On Error Resume Next
        If Mana_Less Then If mReadLong(a + CH_Ma) < Int(Mana_Value) Then enAlert
        If Mana_More Then If mReadLong(a + CH_Ma) > Int(Mana_Value) Then enAlert
    End Sub
