...
Begin VB.Form frmMain 
   ...
   Begin VB.Label Author 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Praetox Technologies 2007"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   18
         Charset         =   0
...
Private Sub cmdHelp_Click()
    ShellExecute 0, "OPEN", "http://www.home.no/xern/TM_Help.html", vbNullString, "C:\", 1
End Sub
...
Sub Form_Load()
    ...
    Apptitle = "Tibia Multi v" & App.Major & "." & App.Minor & "." & App.Revision
    Me.Show
    fadeIn 0, 255
    Light_S = 14
    hken = True
    ...
    DoEvents
    If FEx("alert.mp3") Then
        frmMain.wmp.URL = "alert.mp3"
...
Sub Hotkeys_Timer_Timer()
    ...
    If GetForegroundWindow = tHvnd Then
        ...
        If GetAsyncKeyState(46) = -32767 Then delpressed = True
        If GetAsyncKeyState(17) And delpressed Then hken = Not hken: Smsg "Hotkeys enabled: " & hken
        If delpressed Then doAlert = False: If Music Then wmp.Controls.stop
